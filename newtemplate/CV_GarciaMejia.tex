...
\textsc{Email:} & \href{mailto:jeronimo.maths@gmail.com}{jeronimo.maths@gmail.com}\\
\textsc{Website:} & \href{https://jeronimomaths.github.io}{jeronimomaths.github.io} \\
\textsc{Research Interests:} & Geometric group theory. Geometric, combinatorial, and topological methods in group theory. Nilpotent groups and non-positively curved groups.
\end{longtable}
%----------------------------------------------------------------------------------------
%	WORK EXPERIENCE 
%----------------------------------------------------------------------------------------
...
\begin{enumerate}[align=right, leftmargin=1.8em]
    ...
    %\item \emph{The Dehn functions of Bestvina--Brady groups}.\ In Preparation. With Yu-Chan Chang, Jerónimo García-Mejía, and Matteo Migliorini.
\end{enumerate}
\end{minipage}
...
\begin{longtable}{rp{0.8\linewidth}}
    \textsc{July 2024} & \emph{Dehn functions of nilpotent groups}, \href{https://www.maths.ox.ac.uk/node/68709}{Geometric Group Theory Seminar}, Oxford University, Oxford, England. \\
